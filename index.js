...
module.exports = {
  ...
  termDefaulBNF: require('./lib/florence/defaultBNF/term'),
  statementDefaulBNF: require('./lib/florence/defaultBNF/statement'),
  expressionDefaulBNF: require('./lib/florence/defaultBNF/expression'),
  metastatementDefaulBNF: require('./lib/florence/defaultBNF/metastatement'),
