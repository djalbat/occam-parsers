...
export function continuationContext(innerFunction, continuedContext, context) {
  const continuationContext = ContinuationContext.fromContinuedContext(continuedContext, context);
