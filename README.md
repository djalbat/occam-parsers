...
Mappings allow specific classes to be associated with non-terminal nodes with certain production names.they are come across. This can be used to prune the parse tree as it is generated by discarding needless nodes.
